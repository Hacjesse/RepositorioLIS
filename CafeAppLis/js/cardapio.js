// Uma array onde em cada bloco contem um endereço absoluto de imagem, um nome, e uma descrição
...
// vai passar por cada intem presente na array e executar as açoes dentro do bloco
for (let item of itens) {
  ...
  let itensCardapio = document.getElementById("itens-cardapio"); //Atribui o elemento com o id ("") a variavel
  itensCardapio.insertAdjacentHTML('beforeend', view); // vai inserir o que está em view na pg antes do fim
}